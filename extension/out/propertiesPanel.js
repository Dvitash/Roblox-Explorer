...
class PropertiesPanel {
    ...
    extensionUri;
    currentNodeId = null;
    constructor(backend, treeView, extensionUri) {
    ...
    show(nodeId) {
        ...
        if (!this.panel) {
            this.panel = vscode.window.createWebviewPanel("rblxexplorer.properties", `Properties - ${nodeId}`, vscode.ViewColumn.Beside, {
                enableScripts: true,
